...
function EnemyBase:updateAI(dt)
...
function EnemyBase:wanderBehavior(dt, speed)
    local minDist = 60
...
function EnemyBase:huntBehavior(dt, speed, player)
...
function EnemyBase:scaleToPlayerLevel()
    local player = Game.states.explore.player
    if not player then return end
